...
/* ==========================================================================
   2. ROTA PÚBLICA (LANDING PAGE - FORMULÁRIO DO SITE)
   ========================================================================== */
...
app.post('/api/admin/login', async (req, res) => {
    try {
        ...
        // CORREÇÃO DE SEGURANÇA: Captura o primeiro registro retornado do Array rows de forma segura
...
// Atualizar e persistir todas as métricas avançadas (Cálculos de Comissão e Datas)
